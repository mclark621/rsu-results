...
/// App-specific brand/action colors that aren't part of the core Material color scheme.
class AppColors {
  static const Color actionOrange = Color(0xFFF57C00);
  static const Color onActionOrange = Colors.white;

  static const Color actionPurple = Color(0xFF6D28D9);
  static const Color onActionPurple = Colors.white;
}
